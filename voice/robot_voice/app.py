...
def _run_direct(tool, args: dict, voice: Voice, pending: Pending | None = None,
    ...
    # Разбивку печатаем ПОСЛЕ say: до него звена «синтез» ещё не существует, а
    # именно оно у правил и есть весь ответ — модель тут не спрашивалась вовсе.
    if turn is not None:
        turn.отметить("синтез")
        turn.разложить()
