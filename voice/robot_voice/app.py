...
def main() -> None:
    ...
    лицо.движение.start()
    log.info("ЧЕКПОИНТ 1: после движение.start()")
    ...
    log.info("ЧЕКПОИНТ 2: после Глазомер()")
    # Взгляд лица следует за человеком по пеленгу с камеры.
    лицо.глаза = пеленг
    log.info("ЧЕКПОИНТ 3: после лицо.глаза = пеленг")
    ...
    log.info("ЧЕКПОИНТ 4: после сторож_падений")
    ...
    log.info("ЧЕКПОИНТ 5: после ros.людей_видно")
    ...
    log.info("ЧЕКПОИНТ 6: после Пометки()")
    ...
    log.info("ЧЕКПОИНТ 7: после Атлас()")

    карта = mapping.Карта() if дальномер else None
    log.info("ЧЕКПОИНТ 8: после Карта()")
    ...
    log.info("ЧЕКПОИНТ 9: после Компас()")
    if карта is not None:
        ...
        log.info("ЧЕКПОИНТ 10: после пути карты")
    ...
    спутник = (dog_mod.Спутник(ros, дальномер, план=план, карта=карта,
               ...
               if дальномер is not None and ros is not None else None)
    log.info("ЧЕКПОИНТ 15: после места/ищущий/спутник")
    ...
    log.info("ЧЕКПОИНТ 16: после завести_движитель спутник/поиск")
