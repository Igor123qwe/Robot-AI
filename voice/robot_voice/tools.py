...
def build_tools(ros, timers: Timers, *, speaker=None, notes=None,
    ...
    def _radio_music(что: str) -> str:
        ...
        if найдено is None:
            return (f"Не нашёл ни станции, ни песен — {что}. Скажи иначе." if что
    ...
    def music_volume(изменение: str = "тише") -> str:
