...
def main() -> int:
    for test in (test_rules, test_numbers, test_when, test_timers,
                 ...
                 test_history,
                 test_names, test_dialogue, test_camera, test_vision, test_camera_stream, test_shell_ascii, test_tof, test_fusion, test_tof_guard, test_reflex, test_tof_in_pult, test_depth_to_eyes,
                 test_look_rule):
        test()
        print("   ...")
    if FAILED:
