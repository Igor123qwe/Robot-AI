...
# Отметка «службы крутят вот этот коммит». Пишем в самом конце и всегда, даже
# когда перезапускать было нечего: значит на этом коммите они и так свежие.
# Без записи следующий заход считал бы изменения от того же старого коммита и
